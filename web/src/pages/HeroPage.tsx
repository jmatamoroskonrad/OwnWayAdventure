...
export default function HeroPage() {
  ...
  const lastTour = lastBooking ? tours.find((tour) => tour.id === lastBooking.tourId) : undefined;

  return (
    <div>
      {lastTour && <RitmoSticky title={lastTour.title} tourCount={experienceCount} />}
      <div className="flex flex-col gap-2 desktop:grid desktop:grid-cols-[2fr_1fr]">
        ...
        <SchedulePreview experienceCount={String(experienceCount)} totalAmount={total} />
      </div>
